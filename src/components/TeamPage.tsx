        ...
        >
          ...
          >
            <Box width={'50%'} className="teampage">
              ...
              <Link
                href="https://github.com/briannpham"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
              ...
              <br />
              <Link
                href="https://www.linkedin.com/in/brpham13/"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
          ...
          >
            <Box width={'50%'} className="teampage">
              ...
              <Link
                href="https://github.com/brianhip"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
              ...
              <br />
              <Link
                href="https://www.linkedin.com/in/brian-peinado/"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
          ...
          >
            <Box width={'50%'} className="teampage">
              ...
              <Link
                href="https://github.com/tommyli10"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
              ...
              <br />
              <Link
                href="https://www.linkedin.com/in/tommyli10/"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
          ...
          >
            <Box width={'50%'} className="teampage">
              ...
              <Link
                href="https://github.com/raymonnd"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
              ...
              <br />
              <Link
                href="https://www.linkedin.com/in/raymond-kim0/"
                isExternal
                fontFamily="Arial"
                fontWeight="100"
                letterSpacing={'.1px'}
