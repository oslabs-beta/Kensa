...
const Query = () => {
  ...
  return (
    <>
      <Flex className='copyQuery' justifyContent='flex-end' pb='10px' h='20px' mt='0' mb='5px'>
        {copied ? <Text pr='5px' color='gray'>copied</Text> : <></>}
        <Button h='20px' bg='transparent' className='border-0' onClick={(e) => {copyToClipboard(queryString);}}>
      ...
      <Textarea readOnly value={queryString} bg='whitesmoke' border='1px' borderColor='lightgray' size='sm' h='300px' />
    </>
  );
};
