...
import { Box, Flex, HStack, Image, Text, Hide, Show, Menu, MenuButton, MenuList, MenuItem, IconButton } from "@chakra-ui/react";
...
const Header = () => {
  ...
  return (
    <>
      <Hide below="md">
        <Flex h='10vh' position='fixed' zIndex='100' px={["10px", "25px", "50px"]} py="10px" bg="#FDEEDC" alignItems="center" justifyContent="space-between"  w="100vw">
          <Link to="/"> 
      ...
      <Show below="md">
        <Flex justifyContent='space-between' bg="#FDEEDC">
          ...
          <Menu>
            <MenuButton as={IconButton} aria-label='Options' icon={<GiHamburgerMenu />} variant='ouline' color='black'/>
            <MenuList>
